...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("22222","33333"));
		
		Endereco e1 = new Endereco(null,"Rua Flores","300","apto 203","Jardim","88989898",cli1,c1);
		Endereco e2 = new Endereco(null,"Avenida Matos","105","Sala 800","Centro","2989898",cli1,c2);
